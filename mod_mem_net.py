...
#TODO Correct mutation for write_mem
#TODO Extend distribution to crossover operation
#TODO Write_mem and GRU as different structures
...
class memory_net:
    ...
    def feedforward(self, input): #Feedforwards the input and computes the forward pass of the network
        ...
        self.memory_cell += np.multiply(write_gate_out, self.fast_sigmoid(hidden_act))
...
class SSNE:
        def __init__(self, parameters, ssne_param):
            ...
            if self.ssne_param.type_id == 'memoried':
                ...
                self.hof_net = memory_net(self.ssne_param.num_input, self.ssne_param.num_hnodes,
